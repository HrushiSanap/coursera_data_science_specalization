...
df = pd.read_csv("datasets/historical_automobile_sales.csv")
...
[
    ...
    (
        [
            html.Label("Selection Statistics:"),
            dcc.Dropdown
            (
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        return html.Div([
            html.H4("Please select a report type and/or year to display statistics.", 
